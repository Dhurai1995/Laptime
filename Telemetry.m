...
%             end
            ...
            Tele.Results = {Time,TopV,TimeV,TotalAccTime,DistV,TopA,TotalEnergy,PercentTL,TotalScore,AccScore,AutoXScore,SkidPadScore,EndScore,EScore,TotalTime,avgLatG,avgLongG};
